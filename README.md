...
- 支持直线、抛物线、圆、椭圆、平滑样条和 8 字等代理运动轨迹；摄影机 static、push-in、pull-out、follow、orbit、lateral 均有实际执行轨迹，follow 使用目标相对参考系而非手算世界坐标。
...
```text
cinescaffold @ git+https://github.com/MikaelsCrucible/CineScaffold.git@v0.8.16
```
